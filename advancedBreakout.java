...
/** Radius of popping in bomb mode (after popping white block bomb mode activates */
	private static final double ANNIHILATION_RADIUS = 15;
...
/** These variables tell when laser shot should get reset */
	...
	*/
	...
	private void setLevelLabel() {
		...
		GLabel reminderLaser = new GLabel("Use paddle's builtin laser with mouseclick. You get 1 free shot each level.", WIDTH/2 - 195, HEIGHT/2 - 120);
		...
		reminderBombMode.setColor(Color.MAGENTA);
